...
- **Алхимические бомбы (Alchemical Bombs).** 3 бомбы (кислота, огонь, холод) с уроном 1d6. Атака +9, дистанция 20
  футов.
- **Keen Eyes (полурослик).** +2 обстоятельственный бонус к Восприятию при действии *Seek*.
...
**Стат-блок:** см. § «Моряк — Лучиано Марроне (d6=2)» — [PF2e stat-block].
...
- **Поднимающаяся вода (таймер потопы).** На раунде 5 вода до колена (труднопроходимая местность); на раунде 8 — до
...
- **Скрытный.** Попытка пробраться мимо культистов (Скрытность СЛ 20) к алтарю, чтобы прервать ритуал; при
  критическом успехе — «Врасплох» для одного босса в первом раунде.
- **Социальный.** Запугивание/обман (СЛ 25) Виттории: попытаться заставить её остановить воду до боя; при успехе —
  ритуал прерван без боя, но культ и Моряк остаются.
...
- **Силовой.** Партия вступает в бой; Художник — соло-босс, его сила в тактике и действиях логова. Приоритет —
  лишить его «Врасплох»-целей и нейтрализовать «Ужасающее присутствие».
- **Скрытный.** Попытка пробраться к окну (Скрытность СЛ 20), чтобы перекрыть единственный путь бегства; при
  критическом успехе — Художник «Врасплох» в первом раунде.
...
> готовая к отплытию. У стены стоит Моряк, с ножом в руке. Рядом с ним — двое контрабандистов. «Вы всё-таки пришли», —
...
> Моряк и двое его людей. Дождь стучит по доскам, река тёмная и быстрая. «Отчаливаем», — командует Моряк, и один из
...
Босс — боевая версия из раздела «Финальные боссы»: Моряк (9). Миньоны — 2 контрабандиста (3).
...
> Боевая версия Моряка (L9) — см. § «Финальные боссы». Ниже — только миньон.
...
- **Лодка.** В углу — небольшая лодка, готовая к отплытию; путь бегства Моряка.
...
- **Вода и туман.** Туман — преимущество Моряка; риск сбросить игрока за борт.
- **Канаты.** Обрыв каната (действие логова); путь бегства — отчалить.

#### Возможные сценарии

- **Силовой.** Партия вступает в бой; Моряк — грязный боец, контрабандисты используют «Слаженную работу». Приоритет —
  миньоны, чтобы лишить Моряка поддержки, затем сам Моряк.
- **Скрытный.** Попытка пробраться к лодке/канату (Скрытность СЛ 20), чтобы перехватить путь бегства; при
  критическом успехе — Моряк «Врасплох» в первом раунде.
- **Социальный.** Обман/запугивание (СЛ 25): попытаться заставить Моряка сдаться и выдать тайник/карту до боя; при
