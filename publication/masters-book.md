...
|--------------------|---------|--------------|----|-----|----------------------|
| Гаэтано Вельди     | 7       | Вор          | 24 | 95  | Коварный удар 2d6    |
| Лучиано Марроне    | 7       | Боец/Вор     | 25 | 110 | Двойная атака        |
| Виттория Вельди    | 5       | Жрец Дагона  | 21 | 65  | Волна Дагона         |
| Элио Вентури       | 6       | Алхимик/Жрец | 22 | 75  | Алхимические бомбы   |
| Джакомо Раньери    | 6       | Следователь  | 22 | 80  | Стратегия            |
| Лучиано Аврелиан   | 9       | Чемпион/Вор  | 28 | 151 | Божественная кара    |
| Ильтус Мартис      | 3       | Воин         | 18 | 45  | Пьяный командир      |
| Алессандро Маретти | 8       | Боец         | 26 | 135 | Приказ               |
| Тобиа Бандини      | 2       | Алхимик      | 16 | 30  | Полевая медицина     |
...
> стриженные волосы, серые усталые глаза с постоянной тенью. Плечи чуть ссутулены, руки в мозолях, на левой ладоне —
...
> > > **Гаэтано Вельди — Трактирщик (NPC 7)**
...
| **Навыки**                  | Атлетика +15, Обман +14, Запугивание +12, Воровство +14, Скрытность +15, Ремесло +12, Знание контрабанды +15, Знание Весткроуна +12  |
| **Сила**                    | +4                                                                                                                                   |
| **Ловкость**                | +3                                                                                                                                   |
| **Телосложение**            | +2                                                                                                                                   |
| **Интеллект**               | +0                                                                                                                                   |
| **Мудрость**                | +3                                                                                                                                   |
| **Харизма**                 | +1                                                                                                                                   |
| **AC**                      | 24 (+1 лёгкая кожа, +3 Лов, +7 уровень, +3 эксперт)                                                                                  |
| **HP**                      | 95                                                                                                                                   |
| **Скорость**                | 25 футов                                                                                                                             |
| **Спасброски**              | Стойкость +13, Реакция +16, Воля +14                                                                                                 |
| **Ближний бой**             | Кинжал +1 (Striking) +17 (2d6+7 колющий, 1d6 скрытый)                                                                                |
| **Дальний бой**             | Тяжёлый арбалет +1 (Striking) +16 (3d12+4 колющий)                                                                                   |
| **Специальные способности** | Коварный удар 2d6, Удар из засады, Отвергнуть преимущество, Уклонение, Приёмы оружия, Фигура вора (Ruffian)                          |
| **Снаряжение**              | Кинжал +1 (Striking), Тяжёлый арбалет +1 (Striking), Лёгкая кожа +1, Зелье умеренного лечения (2), Связка ключей, Обручальное кольцо |

**Способности:**

- **Коварный удар (Sneak Attack).** Гаэтано наносит +2d6 урона по существам, у которых есть состояние «Врасплох»
  (Off-Guard).
- **Удар из засады (Surprise Attack).** В первом раунде боя существа, которые ещё не действовали, считаются «Врасплох»
  для Гаэтано.
- **Отвергнуть преимущество (Deny Advantage).** Существа 7 уровня и ниже не могут застать Гаэтано врасплох, даже если он
  не видит их.
- **Уклонение (Evasion).** При успешном спасброске Реакции против эффекта, наносящего урон, Гаэтано не получает урона;
  при критическом успехе — не получает урона и не получает других эффектов.
- **Фигура вора: Ruffian.** Гаэтано может использовать Коварный удар с любым оружием, а не только с ловким или
  метательным.
...
| **Мировоззрение**           | CN                                                                                                                                                       |
| **Раса**                    | Полуэльф                                                                                                                                                 |
| **Класс**                   | Боец (Fighter) / Вор (Rogue, archetype)                                                                                                                  |
| **Восприятие**              | +15 (moderate)                                                                                                                                           |
| **Языки**                   | Общий, Эльфийский, Варисийский                                                                                                                           |
| **Навыки**                  | Атлетика +17, Акробатика +15, Запугивание +14, Скрытность +15, Выживание +13, Морячество +15, Знание контрабанды +14, Знание Весткроуна +12, Ремесло +10 |
| **Сила**                    | +5                                                                                                                                                       |
| **Ловкость**                | +4                                                                                                                                                       |
| **Телосложение**            | +3                                                                                                                                                       |
| **Интеллект**               | +2                                                                                                                                                       |
| **Мудрость**                | +2                                                                                                                                                       |
| **Харизма**                 | +1                                                                                                                                                       |
| **AC**                      | 25 (+1 лёгкая кожа, +4 Лов, +7 уровень, +3 эксперт)                                                                                                      |
| **HP**                      | 110                                                                                                                                                      |
| **Скорость**                | 25 футов                                                                                                                                                 |
| **Спасброски**              | Стойкость +15, Реакция +17, Воля +13                                                                                                                     |
| **Ближний бой**             | Рабочий нож +1 (Striking) +18 (2d6+8 колющий, 1d6 скрытый); Кулак +17 (1d6+7 дробящий, нелетальный)                                                      |
| **Дальний бой**             | Метательный нож +17 (1d6+6 колющий)                                                                                                                      |
| **Специальные способности** | Коварный удар 2d6, Удар из засады, Отвергнуть преимущество, Уклонение, Приёмы оружия, Двойная атака (Double Slice), Атака с разбега (Sudden Charge)      |
| **Снаряжение**              | Рабочий нож +1 (Striking), 4 метательных ножа, Лёгкая кожа +1, Зелье лёгкого лечения (2), Верёвка (50 футов), Перстень (дешёвый)                         |

**Способности:**

- **Коварный удар (Sneak Attack).** Лучиано наносит +2d6 урона по существам, у которых есть состояние «Врасплох»
  (Off-Guard).
- **Двойная атака (Double Slice).** Два удара по одной цели с -2 к каждой атаке; если обе попадают, урон складывается
  для целей сопротивления.
- **Атака с разбега (Sudden Charge).** Перемещение на две дистанции и одна атака ближнего боя.
- **Морской волк (Sea Legs).** Лучиано получает +2 к проверкам Атлетики и Акробатики на корабле или у воды.
...
> > > **Виттория Вельди — Официантка (NPC 5)**
...
| **Языки**                   | Общий, Акло (Aklo), Варисийский                                                               |
| **Навыки**                  | Религия +13, Обман +12, Дипломатия +10, Скрытность +11, Знание культа Дагона +13, Медицина +9 |
| **Сила**                    | +0                                                                                            |
| **Ловкость**                | +2                                                                                            |
| **Телосложение**            | +1                                                                                            |
| **Интеллект**               | +1                                                                                            |
| **Мудрость**                | +4                                                                                            |
| **Харизма**                 | +3                                                                                            |
| **AC**                      | 21 (+1 лёгкая кожа, +2 Лов, +5 уровень, +3 эксперт)                                           |
| **HP**                      | 65                                                                                            |
| **Скорость**                | 25 футов                                                                                      |
| **Спасброски**              | Стойкость +10, Реакция +11, Воля +15                                                          |
| **Ближний бой**             | Ритуальный кинжал +1 (Striking) +11 (2d4+2 колющий)                                           |
| **Дальний бой**             | —                                                                                             |
| **Специальные способности** | Заклинания жреца (СЛ 23), Волна Дагона (Wave of Dagon), Приливная молитва (Tidal Prayer)      |
| **Снаряжение**              | Ритуальный кинжал +1 (Striking), Лёгкая кожа +1, Символ Дагона (скрытый), Дневник, Благовония |

**Заклинания (Cleric, Dagon):**

- **Фокусные:** Волна Дагона (3d6 дробящий, 15-футовый конус), Приливная молитва (даёт союзникам +1 к AC на 1 раунд).
...
| **Навыки**                  | Медицина +15, Религия +13, Ремесло (алхимия) +14, Обман +11, Скрытность +10, Знание культа Дагона +13    |
| **Сила**                    | +0                                                                                                       |
| **Ловкость**                | +2                                                                                                       |
| **Телосложение**            | +1                                                                                                       |
| **Интеллект**               | +4                                                                                                       |
| **Мудрость**                | +3                                                                                                       |
| **Харизма**                 | +2                                                                                                       |
| **AC**                      | 22 (+1 лёгкая кожа, +2 Лов, +6 уровень, +3 эксперт)                                                      |
| **HP**                      | 75                                                                                                       |
| **Скорость**                | 25 футов                                                                                                 |
| **Спасброски**              | Стойкость +11, Реакция +12, Воля +15                                                                     |
| **Ближний бой**             | Скальпель +1 (Striking) +11 (2d4+2 колющий, 1d6 скрытый)                                                 |
| **Дальний бой**             | Метательная склянка +12 (2d6 кислоты/огня, 20 футов)                                                     |
| **Специальные способности** | Алхимические бомбы, Формулы, Быстрое изготовление (Quick Alchemy), Заклинания жреца (СЛ 23)              |
| **Снаряжение**              | Скальпель +1 (Striking), Лёгкая кожа +1, Алхимический набор, Медицинский журнал, Символ Дагона (скрытый) |
...
> > > **Джакомо Раньери — Детектив (NPC 6)**
...
| **Восприятие**              | +14 (moderate)                                                                                                                    |
| **Языки**                   | Общий, Варисийский                                                                                                                |
| **Навыки**                  | Восприятие +14, Общество +13, Знание (местное) +13, Проницательность +15, Медицина +12, Скрытность +11, Запугивание +10           |
| **Сила**                    | +2                                                                                                                                |
| **Ловкость**                | +2                                                                                                                                |
| **Телосложение**            | +2                                                                                                                                |
| **Интеллект**               | +4                                                                                                                                |
...
| **HP**                      | 80                                                                                                                                |
| **Скорость**                | 25 футов                                                                                                                          |
| **Спасброски**              | Стойкость +12, Реакция +12, Воля +16                                                                                              |
| **Ближний бой**             | Дубинка +1 (Striking) +15 (2d6+2 дробящий, нелетальный)                                                                           |
| **Дальний бой**             | Пистолет (Flintlock) +11 (1d6+2 колющий, перезарядка 1)                                                                           |
| **Специальные способности** | Метод следователя (Empiricism), Открытие (Clue In), Стратегия (Devise a Stratagem), Атака с преимуществом (Strategic Strike +2d6) |
| **Снаряжение**              | Дубинка +1 (Striking), Лёгкая кожа +1, Блокнот, Карандаш, Фляжка, Пистолет (10 патронов)                                          |

**Способности:**

- **Стратегия (Devise a Stratagem).** Джакомо может потратить 1 действие, чтобы бросить d20 и запомнить результат; при
  следующей атаке по выбранной цели он использует этот результат вместо броска.
- **Атака с преимуществом (Strategic Strike).** Если Джакомо использует Стратегию и попадает, он наносит +2d6 урона.
- **Открытие (Clue In).** Джакомо может поделиться своим Восприятием с союзниками: один союзник получает +1 к следующей
  проверке Восприятия или Проницательности.
...
|-----------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Уровень**                 | 9                                                                                                                                                                                                       |
| **Мировоззрение**           | LE (падший паладин)                                                                                                                                                                                     |
| **Раса**                    | Аасимар                                                                                                                                                                                                 |
| **Класс**                   | Чемпион (Champion, Selyon) / Вор (Rogue, archetype)                                                                                                                                                     |
| **Восприятие**              | +18 (moderate)                                                                                                                                                                                          |
| **Языки**                   | Общий, Небесный (Celestial), Акло, Варисийский                                                                                                                                                          |
| **Навыки**                  | Акробатика +18, Атлетика +16, Обман +19, Скрытность +18, Религия +16, Ремесло (живопись) +15, Знание культа Дагона +16, Проницательность +16                                                            |
| **Сила**                    | +3                                                                                                                                                                                                      |
| **Ловкость**                | +5                                                                                                                                                                                                      |
| **Телосложение**            | +2                                                                                                                                                                                                      |
| **Интеллект**               | +3                                                                                                                                                                                                      |
| **Мудрость**                | +4                                                                                                                                                                                                      |
| **Харизма**                 | +5                                                                                                                                                                                                      |
| **AC**                      | 28 (+1 лёгкая кожа, +5 Лов, +9 уровень, +3 эксперт)                                                                                                                                                     |
| **HP**                      | 151                                                                                                                                                                                                     |
| **Скорость**                | 30 футов                                                                                                                                                                                                |
| **Спасброски**              | Стойкость +15, Реакция +20, Воля +19                                                                                                                                                                    |
| **Ближний бой**             | Глефа «Шёпот Душ» +2 (Greater Striking) +21 (3d10+7 рубящий, 2d6 скрытый)                                                                                                                               |
| **Дальний бой**             | Метательный нож +20 (2d4+5 колющий)                                                                                                                                                                     |
| **Специальные способности** | Коварный удар 2d6, Удар из засады, Отвергнуть преимущество, Уклонение, Аура защиты (Selyon), Возмездие (Retributive Strike), Божественная кара (Divine Smite), Оружие-реликвия (Glaive of Soul Whisper) |
| **Снаряжение**              | Глефа «Шёпот Душ» +2 (Greater Striking), Лёгкая кожа +1, Набор художника, Лист-живодёр (Flayleaf, 5 доз), Маска культа, Письмо из ордена                                                                |
...
- **Возмездие (Retributive Strike).** Реакция: когда союзник в пределах 15 футов получает урон, Лучиано может атаковать
  врага.
- **Божественная кара (Divine Smite).** При попадании Retributive Strike Лучиано наносит 5 persistent good damage (равно
  модификатору Харизмы +5).
...
| **Мудрость**      | +1                                                 |
| **Харизма**       | +2                                                 |
| **AC**            | 18 (+4 броня, +1 Лов, +3 уровень)                  |
| **HP**            | 45                                                 |
| **Скорость**      | 25 футов                                           |
| **Спасброски**    | Стойкость +9, Реакция +6, Воля +6                  |
| **Ближний бой**   | Длинный меч +9 (1d8+4 рубящий)                     |
...
| **Восприятие**    | +7                                                              |
| **Языки**         | Общий                                                           |
| **Навыки**        | Медицина +9, Ремесло (алхимия) +8, Восприятие +7, Дипломатия +6 |
| **Сила**          | +0                                                              |
| **Ловкость**      | +2                                                              |
| **Телосложение**  | +1                                                              |
| **Интеллект**     | +3                                                              |
| **Мудрость**      | +2                                                              |
| **Харизма**       | +1                                                              |
| **AC**            | 16 (+1 лёгкая кожа, +2 Лов, +2 уровень, +1 эксперт)             |
| **HP**            | 30                                                              |
| **Скорость**      | 25 футов                                                        |
| **Спасброски**    | Стойкость +7, Реакция +8, Воля +6                               |
| **Ближний бой**   | Скальпель +7 (1d4+2 колющий)                                    |
| **Дальний бой**   | Метательная склянка +7 (1d6 кислоты, 20 футов)                  |
| **Снаряжение**    | Скальпель, Лёгкая кожа, Алхимический набор, Медицинский журнал  |

**Способности:**

- **Полевая медицина (Field Medicine).** Тобиа может лечить 1d8 HP за 10 минут (проверка Медицины СЛ 15).
- **Алхимические бомбы (Alchemical Bombs).** 3 бомбы (кислота, огонь, холод) с уроном 1d6.
...
| **Ближний бой**             | Кинжал +2 (Greater Striking) +20 (3d4+6 колющий, 3d6 скрытый)                                                            |
| **Дальний бой**             | Метательный нож +20 (2d4+5 колющий)                                                                                      |
| **Специальные способности** | Коварный удар 4d6, Удар из засады, Отвергнуть преимущество, Уклонение, Мастер-ум (Mastermind), Анализ (Analyze Weakness) |
| **Снаряжение**              | Кинжал +2 (Greater Striking), Лёгкая кожа +2, Кольцо защиты, Зелье высшего лечения                                       |

**Способности:**

- **Коварный удар (Sneak Attack).** +4d6 урона по существам в состоянии «Врасплох».
- **Мастер-ум (Mastermind).** Если Вассиндио успешно использует Проницательность или Знание против цели, цель становится
  «Врасплох» для него до конца его следующего хода.
...
| **AC**                      | 21                                                                                                                                      |
| **HP**                      | 60 (иммунитет к немагическому оружию)                                                                                                   |
...
> Божественная кара (Divine Smite) = 5 persistent good damage (модификатор Харизмы +5).
...
- **Касание утопленника (1 действие):** Атака заклинанием ближнего боя +17, 3d6 холодного урона; цель должна пройти
  спасбросок Стойкости СЛ 25, иначе «Замедлен 1» на 1 раунд.
...
> Элио выходит из тени с скальпелем в одной руке и склянкой в другой. Его лицо бледно, но спокойно — как у
...
- **Анестезирующий яд (1 действие):** Наносит яд на оружие; следующее попадание наносит +2d6 яда, цель проходит
  спасбросок Стойкости СЛ 22, иначе «Замедлен 1» на 1 раунд.
...
- **Скрытый удар 2d6:** Когда цель «Врасплох» (Off-Guard).
...
- **Уклонение (Evasion):** При успешном спасброске Реакции — нет урона; при критическом успехе — нет урона и
  эффектов.
- **Защитный удар (реакция):** Когда союзник в пределах 10 футов получает урон от атаки, Гаэтано может переместиться
  к нему и принять урон на себя (атака наносит ему половину урона).
- **Телохранитель (1 действие):** Даёт +2 к AC союзнику в пределах касания до начала своего следующего хода.
...
| **Ближний бой**   | Глефа «Шёпот Душ» +2 (Greater Striking): +19 (extreme), 3d8+7 рубящий, +2d6 скрытый удар                                                                                                           |
| **Дальний бой**   | Метательный нож +17 (high), 2d4+5 колющий                                                                                                                                                          |

**Способности:**

- **Скрытый удар 2d6.**
- **Божественная кара (Divine Smite):** При попадании ближним боем Художник наносит цели 5 persistent good damage
  (модификатор Харизмы +5); действует до его следующего хода.
- **Сокрушительный удар (1 действие):** Атака; при попадании цель «Врасплох» до конца следующего хода Художника.
- **Художественная казнь (2 действия, 1/раунд):** Атака по цели «Врасплох»; при попадании +2d6 урона, цель проходит
  спасбросок Стойкости СЛ 27, иначе «Замедлен 1» (спасбросок в конце каждого хода).
...
- **Шёпот душ (реакция):** При попадании по цели он может заставить её пройти спасбросок Воли СЛ 27, иначе
  «Ошеломлён 1» на 1 раунд.
- **Действия логова (на инициативе 20, проигрывая ничьи):**
    - **Сдвиг холста:** Один квадрат 10×10 футов становится труднопроходимым.
    - **Цвета безумия:** Одно существо в пределах 60 футов проходит спасбросок Воли СЛ 25, иначе «Запутан» на 1
      раунд.
    - **Кровь на кисти:** Художник восстанавливает 15 HP и получает +1 к следующей атаке.

---

### 3. Одиночный босс: Лучиано «Ржавый» Марроне — Моряк (Level 9)

**Бюджет:** 160 XP (Extreme).

**Что зачитать игрокам при первой встрече (боевая версия):**

> Моряк стоит, широко расставив ноги, с ножом в руке. Его лицо перекошено — уже не настороженность, а голая злоба.
...
- **Скрытый удар 2d6.**
- **Грязный приём (1 действие):** Атлетика против Стойкости цели; при успехе цель «Ослеплена» или «Врасплох» на 1
  раунд.
...
- **Морские ноги:** +2 к Атлетике и Акробатике у воды; игнорирует труднопроходимую местность от влажных
  поверхностей.
- **Не уйти (реакция):** Когда существо перемещается прочь, Моряк совершает Перемещение за ним (до своей скорости).
- **Жестокий финал (1 действие, 1/раунд):** Атака по цели «Врасплох»; +2d6 урона; при попадании цель проходит
  спасбросок Стойкости СЛ 27, иначе «Сбит с ног».
- **Действия логова (на инициативе 20, проигрывая ничьи):**
    ...
    - **Канат:** Верёвка или цепь пролетает по линии 20 футов; существа проходят спасбросок Реакции СЛ 25, иначе
      3d6 дробящего урона и «Сбит с ног».
    - **Соль на рану:** Моряк восстанавливает 15 HP и может немедленно совершить «Грязный приём» против смежного
      существа.
...
- **Разработать стратегию (1 действие):** Бросок d20; до конца хода использует этот результат для следующей атаки
  по выбранной цели.
- **Стратегический удар:** При попадании по цели, для которой разработана стратегия, +2d6 точного урона.
- **Подсказка (1 действие):** Даёт союзнику +1 к следующей проверке Восприятия или Проницательности.
- **Удар пистолетом (1 действие):** Атака ближнего боя рукоятью пистолета; при попадании цель «Врасплох».
...
| Моряк             | 9       | 160     | Extreme     | Dirty fighter     |
...
6. **Моряк и Детектив** — не «сверхъестественные» боссы. Их сила — в тактике, грязных приёмах и подготовке. Если
   хотите сделать их более «эпичными», дайте им артефакт или связь с культом (например, Моряк носит амулет Дагона,
...
> Развёрнутые варианты финальных боёв с окружением, миньонами, действиями логова и таймером потопы. Боссы (Виттория,
> Элио, Гаэтано, Художник, Моряк) — боевые версии из раздела «Финальные боссы». Новые миньоны: культист Дагона (2) и
...
**Контрабандисты тоже нужны.** Моряк в одиночку против четырёх игроков — это дисбаланс действий (3 против 12). Пара
...
| **Склад/ялик Моряка**    | 200 XP | Extreme+  |
...
#### Что зачитать игрокам при входе
...
| 5–6 | **Шёпот Дагона.** Все враги в пределах 30 футов проходят спасбросок Воли СЛ 22, иначе «Испуган 1».                                                                     |
...
- **Раунд 2:** Виттория применяет «Касание утопленника» по самому опасному бойцу. Элио использует «Волну тошноты».
  Гаэтано применяет «Телохранитель» на Витторию.
...
- **Сдача Виттории:** Если Виттория при смерти, она предлагает сделку: «Убейте Моряка — и я остановлю воду». Мастер
...
- **Раунд 2:** «Художественная казнь» по цели «Врасплох». Если цель — заклинатель, он фокусируется на ней.
...
### 3. Склад контрабанды / ялик Моряка
...
#### Что зачитать игрокам при входе (склад)

> Вы подходите к складу на берегу реки. Дверь приоткрыта, внутри горит одинокая лампа. Пахнет солью, дёгтем и гнилью.
> Внутри — ящики, бочки, сети. На стене — карта реки с пометками. В углу — небольшая лодка, готовая к отплытию. У
> стены стоит Моряк, с ножом в руке. Рядом с ним — двое контрабандистов. «Вы всё-таки пришли», — говорит он, и в его
> голосе нет удивления. Только усталость.

#### Что зачитать игрокам при входе (ялик)

> Вы выходите на причал. У борта покачивается ялик — небольшое судно с чёрным парусом. На палубе — Моряк и двое его
> людей. Дождь стучит по доскам, река тёмная и быстрая. «Отчаливаем», — командует Моряк, и один из контрабандистов
> тянется к канату. Вы должны действовать быстро.

#### Обитатели

| Персонаж           | Уровень | XP         |
|--------------------|---------|------------|
| Лучиано Марроне    | 9       | 160        |
...
- **Скрытый удар 1d6:** Когда цель «Врасплох» (Off-Guard).
- **Грязный приём (1 действие):** Атлетика против Стойкости; при успехе цель «Врасплох» или «Сбита с ног».
- **Морские ноги:** +2 к Атлетике и Акробатике у воды; игнорирует труднопроходимую местность от влажных
  поверхностей.
...
- **Раунд 1:** Моряк применяет «Грязный приём» по ближайшему. Контрабандисты окружают и используют «Слаженную
  работу».
- **Раунд 2:** Моряк применяет «Двойной разрез» по цели «Врасплох». Контрабандисты используют «Грязный приём»,
  чтобы сбить с ног.
- **Раунд 3+:** Моряк использует «Жестокий финал» по самой опасной цели. Если бой на ялике — он пытается сбросить
  кого-то за борт (Атлетика против Стойкости).
- **При 50% HP:** Моряк пытается сбежать (если на ялике — отчаливает; если на складе — бежит к лодке).
  Контрабандисты прикрывают отход.

#### Условия победы и поражения

- **Победа игроков:** Моряк повержен. На его теле — украденная казна «Чёрной Сирены» и карта контрабандных маршрутов.
- **Поражение игроков:** Моряк убивает их или бросает в реку. Если партия проигрывает на ялике — их могут утопить.
- **Сдача Моряка:** При 0 HP он хрипит: «Пощади… я скажу… где тайник…» — и может выдать информацию о Трактирщике или
  Совете Воров.
...
| **Склад/ялик**    | Моряк (9)                           | 2 контрабандиста (3) | 200 | Extreme+  |
...
3. **Склад/ялик** — сбалансированный бой. Если хотите усилить, добавьте третьего контрабандиста (220 XP) или дайте
   Моряку амулет Дагона (+1 к AC и сопротивление холоду).
